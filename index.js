...
const config = require('./rvnserve.json')
const express = require('express')
const rvnqueryd = require('rvnqueryd')
...
var run = async function() {
  ...
  app.listen(config.port, () => {
    console.log("######################################################################################");
    console.log("#")
    console.log("#  RVNSERVE: RvnDB Microservice")
    console.log("#  Serving Ravencoin through HTTP...")
    console.log("#")
